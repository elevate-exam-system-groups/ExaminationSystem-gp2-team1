        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassScore = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 60m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FailedOtpAttempts = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDiplomaEnrollments", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentDiplomaEnrollments_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "Student role - can take quizzes and view their progress", false, "Student", null, null },
                    { new Guid("10000000-0000-0000-0000-000000000002"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "Administrator role - full system access", false, "Admin", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttemptAnswers_AttemptId_QuestionId_Unique",
                table: "AttemptAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpRecords_ExpiresAt",
                table: "OtpRecords",
                column: "ExpiresAt");

            migrationBuilder.CreateIndex(
                name: "IX_OtpRecords_UserId_IsUsed",
                table: "OtpRecords",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_DeadlineAt",
                table: "QuizAttempts",
                column: "DeadlineAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentDiplomaEnrollments_StudentId",
                table: "StudentDiplomaEnrollments",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentDiplomaEnrollments_StudentId_DiplomaId_Unique",
                table: "StudentDiplomaEnrollments",
                columns: new[] { "StudentId", "DiplomaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_Name_Unique",
                table: "UserRoles",
                column: "Name",
                unique: true);
